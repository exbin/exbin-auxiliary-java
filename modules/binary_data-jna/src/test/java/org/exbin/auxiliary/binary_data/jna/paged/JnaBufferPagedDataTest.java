...
public class JnaBufferPagedDataTest {
    ...
    public void testIsEmpty() {
        PagedData instanceA = new JnaBufferPagedData(8);
        instanceA.insert(0, testUtils.getSampleDataA());
        ...
        PagedData instanceD = new JnaBufferPagedData(8);
        assertEquals(true, instanceD.isEmpty());

        PagedData instanceE = new JnaBufferPagedData(8);
    ...
    public void testInsert() {
        ...
        PagedData instanceB2 = new JnaBufferPagedData(8);
    ...
    public void testLoadFromStream() throws Exception {
        ...
        PagedData instanceB = new JnaBufferPagedData();
        ...
        PagedData instanceC = new JnaBufferPagedData();
