...
public class ByteArrayPagedDataRangeInputStream extends InputStream implements SeekableStream, FinishableStream {
    ...
    public ByteArrayPagedDataRangeInputStream(ByteArrayPagedData data) {
        this.data = data;
    ...
    public ByteArrayPagedDataRangeInputStream(ByteArrayPagedData data, long startPosition, long length) {
        if (startPosition < 0) {
